...
class Uploader extends \Magento\Backend\App\Action
{
    ...
    {
        $imageUploadId = $this->getRequest()->getParam('param_name','path');
        // $imageUploadId = "123bvs3432";
        ...
        try {
            ...
            $basePath = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'portfolio/image/';
            $mediaRootDir = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'portfolio/image/' . $firstName . '/' . $secondName . '/';
            ...
            $imageResult['url'] = $mediaUrl . 'portfolio/image/' . $firstName . '/' . $secondName . '/' . $newImageName;
        } catch (\Exception $e) {
